# Tutorial for running a real-case regional MONAN simulation with ERA5 data
...
2) Many "intermediate files" containing preprocessed data from your real dataset, named `ERA5:2007-06-*`, within /mnt/beegfs/`$USER`/scripts_CD-CT/dataout/2007062200/Pre
...
4) Many "lbc files" containing the interpolated lateral boundary conditions from that intermediate file, named lbc*.nc within /mnt/beegfs/`$USER`/scripts_CD-CT/dataout/2007062200/Pre
