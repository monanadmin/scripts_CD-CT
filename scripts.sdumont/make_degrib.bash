...
GCCCIS=/scratch/cptec/dados/CIs/${EXP}
#-------------------------------------------------------
...
# busca no nosso dir /dados/monan/MONAN_datain/CIs, se nao existir tbm, aborta!
...
files_needed=("${DATAIN}/fixed/x1.${RES}.static.nc" "${DATAIN}/fixed/Vtable.${EXP}" "${BNDDIR}/gfs.t00z.pgrb2.0p25.f000.${YYYYMMDDHHi}.grib2")
...
tcsh ./link_grib.csh ${DATAIN}/${YYYYMMDDHHi}/gfs.t00z.pgrb2.0p25.f000.${YYYYMMDDHHi}.grib2
