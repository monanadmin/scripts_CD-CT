...
rm -f ${SCRIPTS}/submit_init_cptec.srm
cat << EOF0 > ${SCRIPTS}/submit_init_cptec.srm 
#!/bin/bash
#SBATCH --job-name=${INITATMOS_jobname}
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
date
time mpirun -n \$SLURM_NTASKS ./init_atmosphere_model
date
...
EOF0
chmod a+x ${SCRIPTS}/submit_init_cptec.srm

echo -e  "${GREEN}==>${NC} Executing sbatch initatmos.bash...\n"
cd ${SCRIPTS}
echo -e  "sbatch ${SCRIPTS}/submit_init_cptec.srm"
sbatch --wait -N1 -n${cores} -c1 ${SCRIPTS}/submit_init_cptec.srm
mv ${SCRIPTS}/submit_init_cptec.srm ${DATAOUT}/${YYYYMMDDHHi}/Pre/logs
