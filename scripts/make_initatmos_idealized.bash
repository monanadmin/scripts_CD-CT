...
files_needed=("${SCRIPTS}/namelists/namelist.init_atmosphere.TEMPLATE_IDEALIZED" "${SCRIPTS}/namelists/streams.init_atmosphere.TEMPLATE_IDEALIZED" "${DATAIN}/fixed/${MESH}.graph.info.part.${cores}" "${DATAIN}/fixed/${MESH}.grid.nc" "${EXECS}/init_atmosphere_model")
...
sed -e "s,#LABELI#,${start_date},g;s,#TESTCASENUMBER#,"${EXP: -1}",g;s,#MESH#,${MESH},g" \
	 ${SCRIPTS}/namelists/namelist.init_atmosphere.TEMPLATE_IDEALIZED > ${DIRRUN}/namelist.init_atmosphere

sed -e "s,#MESH#,${MESH},g" \
    ${SCRIPTS}/namelists/streams.init_atmosphere.TEMPLATE_IDEALIZED > ${DIRRUN}/streams.init_atmosphere
