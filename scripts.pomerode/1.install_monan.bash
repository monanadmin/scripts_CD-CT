...
make -j 8 nvhpc CORE=atmosphere USE_PIO=true OPENACC=true PRECISION=single 2>&1 | tee \${MAKE_OUT_FILE}
...
make -j 8 nvhpc CORE=init_atmosphere USE_PIO=true OPENACC=true PRECISION=single 2>&1 | tee \${MAKE_OUT_FILE}
